...
[`docs/generation_docs/behavior_methodology.md`](../../generation_docs/behavior_methodology.md).

---

## Table of Contents

- [What tg-model Supports Today](#what-tg-model-supports-today)
  - [State Machine API](#state-machine-api)
  - [Activity / Control-Flow API](#activity--control-flow-api)
  - [Inter-Part Items](#inter-part-items)
  - [Scenarios](#scenarios)
  - [Projection Hook](#projection-hook)
- [ThunderGraph Data Model](#thundergraph-data-model)
  - [State Diagram Shape](#state-diagram-shape)
  - [Activity Diagram Shape](#activity-diagram-shape)
- [DSL → ThunderGraph Mapping](#dsl--thundergraph-mapping)
  - [State Diagram Mapping](#state-diagram-mapping)
  - [Activity Diagram Mapping](#activity-diagram-mapping)
- [Gaps: What Is Not Yet Wired](#gaps-what-is-not-yet-wired)
