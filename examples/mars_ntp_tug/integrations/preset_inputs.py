...
def merge_mars_ntp_eval_inputs(
    ...
    *,
    ...
    return {
        ...
        cm.mission_sizing.mission_delta_v_required: napkin["delta_v_m_s"],
        cm.mission_sizing.thermal_to_jet_efficiency: napkin["thermal_to_jet_efficiency"],
        cm.mission_sizing.propellant_loadout_margin: napkin["propellant_loadout_margin"],
        cm.mission_sizing.jet_kinetic_fraction: napkin["jet_kinetic_fraction"],
